...
export type HBBufferInstanceJSON = {
  g: number
  cl: number
  ax: number
  ay: number
...
export type HBFontDirection = 'ltr' | 'rtl' | 'ttb' | 'btt'

export type HBJSONCharacter = {
  g: number
  cl: number
  ax: number
  ay: number
...
export type HBTextOptions = {
  direction: HBFontDirection
  features?: HBTextFeature[]
  variations?: Record<string, number>
}

export type HBTextFeature = {
  tag: string
  value: number
}

export type HBJSONRepresentation = {
  type: string
  values: number[]
}
